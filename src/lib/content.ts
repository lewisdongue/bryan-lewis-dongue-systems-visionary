...
const fr: Copy = {
  ...
  timeline: [
    ...
    { year: "2023", title: "Installation à Worms", text: "Départ pour l'Allemagne et début du cursus à la Hochschule Worms." },
    { year: "2024", title: "Années d'études", text: "Étudiant à plein temps à la Hochschule Worms : rigueur académique, approfondissement de l'architecture logicielle et maturation de la vision Caakus." },
    { year: "Octobre 2025", title: "Début du développement de Caakus", text: "En octobre 2025, il commence le développement effectif de Caakus : architecture vocale temps réel, backend audio/vidéo faible latence et conception de l'économie Yuyu." },
...
const en: Copy = {
  ...
  timeline: [
    ...
    { year: "2023", title: "Move to Worms", text: "Relocation to Germany and start of studies at Hochschule Worms." },
    { year: "2024", title: "Student years", text: "Full-time student at Hochschule Worms: academic rigor, deeper software architecture work and the maturing of the Caakus vision." },
    { year: "October 2025", title: "Caakus development begins", text: "In October 2025 he starts the actual development of Caakus: real-time voice architecture, low-latency audio/video backend and the design of the Yuyu economy." },
...
export const VOICE_SCRIPT: Record<Lang, string> = {
  ...
  de: "Hallo, ich bin Bryan Lewis Dongue Ndiffo, Gründer und CEO von Caakus. Ich bin Systemarchitekt in Worms, Deutschland, und baue eine Echtzeit-Sprachinfrastruktur, die Menschen in einer Sekunde verbindet. Willkommen — entdecken Sie meinen Werdegang, meine Vision und das Caakus-Ökosystem.",
  es: "Hola, soy Bryan Lewis Dongue Ndiffo, fundador y CEO de Caakus. Soy arquitecto de sistemas, radicado en Worms, Alemania, y construyo una infraestructura de voz en tiempo real que conecta a las personas en un segundo. Bienvenido: explora mi trayectoria, mi visión y el ecosistema Caakus.",
  pt: "Olá, sou Bryan Lewis Dongue Ndiffo, fundador e CEO da Caakus. Sou arquiteto de sistemas, radicado em Worms, na Alemanha, e construo uma infraestrutura de voz em tempo real que liga as pessoas num segundo. Bem-vindo: explore o meu percurso, a minha visão e o ecossistema Caakus.",
  it: "Ciao, sono Bryan Lewis Dongue Ndiffo, fondatore e CEO di Caakus. Sono un architetto di sistemi con base a Worms, in Germania, e costruisco un'infrastruttura vocale in tempo reale che connette le persone in un secondo. Benvenuto: esplora il mio percorso, la mia visione e l'ecosistema Caakus.",
};

...
const fr: Copy = {
  ...
  timeline: [
    ...
    { year: "2025", title: "Caakus Inc.", text: "Structuration de Caakus Inc. et déploiement de l'écosystème de la valeur humaine." },
  ...
  faq: [
    ...
    { q: "Qu'est-ce que Caakus Inc. ?", a: "Caakus Inc. est la société technologique fondée par Bryan Lewis Dongue Ndiffo. Elle développe une plateforme sociale vocale en temps réel qui met instantanément en relation des personnes par appel audio ou vidéo, guidée par une IA d'appariement comportemental et adossée à l'économie de la valeur humaine et au jeton utilitaire Yuyu." },
...
const en: Copy = {
  ...
  timeline: [
    ...
    { year: "2025", title: "Caakus Inc.", text: "Structuring of Caakus Inc. and rollout of the Human Value Economy ecosystem." },
  ...
  faq: [
    ...
    { q: "What is Caakus Inc.?", a: "Caakus Inc. is the technology company founded by Bryan Lewis Dongue Ndiffo. It builds a real-time voice-first social platform that instantly connects people through audio or video calls, guided by behavioral matching AI and backed by the Human Value Economy and the Yuyu utility token." },
